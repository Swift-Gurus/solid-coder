"""
solid-description: Logs labeled events and function execution for debugging.
...
class DebugLogger:
    """Appends timestamped label/event pairs to {project_dir}/debug.log.
    ...
    def log(self, label: str, event: str) -> None:
        try:
            log_path = self._project_dir_fn() / "debug.log"
