"""
solid-description: Determines which flow steps are ready to execute based on run history.
...
class ReadyStepsResolver:
    ...
    def resolve(self, events_path: str, flow_def: FlowDef, params: dict, detected_env: str) -> list[StepResult]:
        ...
        return self._step_result_builder.build(snapshot.ready, flow_def, detected_env, snapshot.run_state)
