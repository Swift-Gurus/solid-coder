"""
solid-name: DelegateInstructionBuilder
solid-category: service
solid-spec: [SPEC-027]
solid-description: Enriches input with execution instructions for a delegate step.
"""
...
class DelegateInstructionBuilder:

    def build(self, prompt: str) -> str:
        return build_delegate_instruction(prompt)
