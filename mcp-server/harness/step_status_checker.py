...
solid-description: Determines whether a workflow step is terminal or currently running.
"""
class StepStatusChecker(StepStatusChecking):
    def is_done_or_running(self, step_id: str, run_state: RunState) -> bool:
        return (
            step_id in run_state.completed
            or step_id in run_state.skipped
            or step_id in run_state.running
        )
